...
Общее описание
«Squares And Coins» — это динамичная аркадная игра, где вы управляете зеленым квадратом, собираете монеты и избегаете врагов. Игра сочетает в себе элементы стратегии, реакции и планирования.

Управление
W, A, S, D или стрелки — движение персонажа

Пробел — активация турбо-режима (временное увеличение скорости)
...
Цель игры
Собрать как можно больше монет за отведенное время, избегая столкновений с красным квадратом (врагом).

Игровые элементы
Персонажи и объекты:
Зеленый квадрат — ваш персонаж

Красный квадрат — враг, который преследует вас

Разноцветные круги — монеты разных типов

Кристаллы — специальные объекты, дающие дополнительные жизни

Часы — временные бонусы, замедляющие врага
...
Темно-зеленые мины (-1 жизнь) — опасные предметы
...
Таймер — игра ограничена по времени

Особенности:
При столкновении с врагом теряется одна жизнь

Сбор кристаллов добавляет дополнительные жизни

Временные бонусы замедляют врага на несколько секунд

При столкновении с миной теряется жизнь
...
Стратегия и советы
Используйте турбо-режим экономно — для быстрого сбора отдаленных монет

Следите за временем — планируйте маршрут сбора монет

Избегайте прямых столкновений с красным квадратом

Собирайте белые монеты для быстрого набора очков

Используйте кристаллы для увеличения количества жизней

Временные бонусы помогают в сложных ситуациях
...
Система рекордов
Игра сохраняет ваши лучшие результаты и позволяет сравнивать их с достижениями других игроков.

Перезапуск игры
После завершения игры нажмите ПРОБЕЛ, чтобы начать заново.
